...
User Function tst1Connect()
	...
	If lRet
		...
		//Define a operação com a qual será trabalhada no Documento Hábil em questão
		lRet := oWsdl:SetOperation( "obterCriticaLote" )
		If lRet
			oWsdl:cLocation := "https://nfsehomol.garibaldi.rs.gov.br/portal/Servicos"
			...
			cXml += '<cLote>13585</cLote>'
			cXml += '</pedidoStatusLote>'

			cXml := SignNFSeA1(cXml,"pedidoStatusLote","","000005","Euro@2016")
			...
			if lRet
				...
				//Retirado o elemento da tag devido o obj nao suportar
				/*
				cMsg := StrTran(cMsg, 'SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/" ', '')
