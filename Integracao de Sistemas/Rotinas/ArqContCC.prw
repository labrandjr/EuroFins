...
If cCart == "R"
	cLinCabec := "CNPJ EUROFINS;INDICACAO DA NOTA;DATA EMISSAO DOCUMENTO;ESPECIE;SERIE DA NOTA;NUMERO DA NOTA;CNPJ-CPF CLIENTE;NUM NOTA+PARCELA;DATA VENCIMENTO;VALOR A BAIXAR;CONTA DE PGTO;DATA BAIXA;VALOR PAGO;JUROS;DESCONTO"
	aCabExcel := {"CNPJ EUROFINS","INDICACAO DA NOTA","DATA EMISSAO DOCUMENTO","ESPECIE","SERIE DA NOTA","NUMERO DA NOTA","CNPJ-CPF CLIENTE","NUM NOTA+PARCELA","DATA VENCIMENTO","VALOR A BAIXAR","CONTA DE PGTO","DATA BAIXA","VALOR PAGO","JUROS","DESCONTO"}
	...
	While NEWSE5->(!Eof()) .And. &cCondFil .And. &cCondicao .and. lContinua
		...
		While NEWSE5->(!EOF()) .and. &cCond2=cAnterior .and. &cCondFil .and. lContinua
			...
			If (nDesc+nValor+nJurMul+nCM+nVlMovFin) > 0
				...
				If cCart == "R"
					cCpo10 := StrTran(StrZero(nValor,13,2),".",",")+";"                                               	// Valor a baixar
					...
					cCpo13 := StrTran(StrZero(nValor-nJurMul+nDesc,13,2),".",",")+";"                             // Valor baixado
				...
				if cCart == "P" .and. cCpo4 == "FAT;"
					...
					if !getTitulos(@nHdl,@aItExcel,cNumero,cCpo1,cCpo2,cCpo6,cCpo7,cCpo9,cCpo10,cCpo11,_cEOL,cFornece,cLoja)
						if fWrite(nHdl,cLin,Len(cLin)) != Len(cLin)
							...
							if cCart == "R"
								aadd(aItExcel , {cCpo1,cCpo2,cCpo3,cCpo4,cCpo5,cCpo6,cCpo7,cCpo8,cCpo9,cCpo10,cCpo11,cCpo12,cCpo13,cCpo14,cCpo15})
					...
					If cCart == "R"
						cLin += cCpo1+cCpo2+cCpo3+cCpo4+cCpo5+cCpo6+cCpo7+cCpo8+cCpo9+cCpo10+cCpo11+cCpo12+cCpo13+cCpo14+cCpo15+_cEOL
