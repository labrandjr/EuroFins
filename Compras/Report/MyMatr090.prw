...
Emissão da relação de compras
@author Alexandre Inacio Lemes
@since 29/12/2017
/*/
User Function MyMatr090()
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	oReport:= TReport():New("MyMATR090",cTitle,"MTR090", {|oReport| ReportPrint(oReport,aOrdem,cAliasSD1)},STR0002+" "+STR0003) //"Este relatorio ira imprimir a relacao de itens referentes a compras efetuadas."
...
// Adiciona por Regis Ferreira - Totvs IP - 25/10/2021 - Solicitação de Camila Nascimento
	...
	TRCell():New(oSection1, "D1_LOJA"     , "SD1", "Loja"          , /*Picture*/, TamSX3("D1_LOJA")[1]+10   , /*lPixel*/ , /*{|| code-block de impressao }*/)
	TRCell():New(oSection1, "A2_CGC"      , "SD1", "CNPJ/CPF"      , /*Picture*/, TamSX3("A2_CGC")[1]+10    , /*lPixel*/ , /*{|| code-block de impressao }*/)
...
// Adiciona por Regis Ferreira - Totvs IP - 25/10/2021 - Solicitação de Camila Nascimento
	TRCell():New(oSection1, "F1_ESPECIE"  , "SF1",                 , /*Picture*/, /*Tamanho*/               , /*lPixel*/ , /*{|| code-block de impressao }*/)
	TRCell():New(oSection1, "D1_GRUPO"    , "SD1", /*Titulo*/      , /*Picture*/, /*Tamanho*/               , /*lPixel*/ , /*{|| code-block de impressao }*/)
	TRCell():New(oSection1, "D1_EMISSAO"  , "SD1",                 , /*Picture*/, /*Tamanho*/               , /*lPixel*/ , /*{|| code-block de impressao }*/)
	TRCell():New(oSection1, "F1_RECBMTO"  , "SF1",                 , /*Picture*/, /*Tamanho*/               , /*slPixel*/, /*{|| code-block de impressao }*/)
	TRCell():New(oSection1, "D1_DTDIGIT"  , "SD1", STR0036         , /*Picture*/, /*Tamanho*/               , /*slPixel*/, /*{|| code-block de impressao }*/)
	TRCell():New(oSection1, "F1_XDTCLAS"  , "SF1",                 , /*Picture*/, /*Tamanho*/               , /*slPixel*/, /*{|| code-block de impressao }*/)

	TRCell():New(oSection1, "Venc. NF"    , " "  ,                 , /*Picture*/, /*Tamanho*/               , /*lPixel*/ , {|| GetVencNF((CALIASSD1)->D1_DOC,(CALIASSD1)->D1_SERIE,(CALIASSD1)->D1_FORNECE,(CALIASSD1)->D1_LOJA,D1_FILIAL)})
	TRCell():New(oSection1, "Pagto NF"    , " "  ,                 , /*Picture*/, /*Tamanho*/               , /*lPixel*/ , {|| GetPagNF((CALIASSD1)->D1_DOC,(CALIASSD1)->D1_SERIE,(CALIASSD1)->D1_FORNECE,(CALIASSD1)->D1_LOJA,(CALIASSD1)->D1_FILIAL)})
	TRCell():New(oSection1, "Emis. PC"    , "SD1",                 , /*Picture*/, /*Tamanho*/               , /*lPixel*/ , {|| Posicione("SC7",1,xFilial("SC7")+(CALIASSD1)->D1_PEDIDO+(CALIASSD1)->D1_ITEMPC,"C7_EMISSAO")})
	TRCell():New(oSection1, "D1_PEDIDO"   , "SD1",                 , /*Picture*/, /*Tamanho*/               , /*lPixel*/ , /*{|| code-block de impressao }*/)
	TRCell():New(oSection1, "Pedido Coupa", "SD1",                 , /*Picture*/, /*Tamanho*/               , /*lPixel*/ , {|| Posicione("SC7",1,xFilial("SC7")+(CALIASSD1)->D1_PEDIDO+(CALIASSD1)->D1_ITEMPC,"C7_ZZCCOUP")})
	TRCell():New(oSection1, "D1_CONTA"    , "SD1",                 , /*Picture*/, /*Tamanho*/               , /*lPixel*/ , /*{|| code-block de impressao }*/)
	TRCell():New(oSection1, "Descr. Conta", " "  , /*Titulo*/      , /*Picture*/, /*Tamanho*/               , /*lPixel*/ , {|| Posicione("CT1",1,xFilial("CT1")+(CALIASSD1)->D1_CONTA,"CT1_DESC01")})
...
// Adicionado por Guilherme Ricci - TOTVS IP - 20/01/2016 - Solicitado no chamado 2016011910017728 por Thiago Almeida
	...
	TRCell():New(oSection1,"D1_ZZCODF"  ,"SD1","Cod.Pr.Forn."	,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)

// Fim adicao

// Adicionado por Vinicius Camargo - TOTVS IP - 03/02/2022 - Chamado AMS 39814
	TRCell():New(oSection1,"D1_CC"  ,"SD1","Centro de Custo"	,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| Posicione("SD1",1,xFilial("SD1")+(CALIASSD1)->D1_DOC+(CALIASSD1)->D1_SERIE+(CALIASSD1)->D1_FORNECE+(CALIASSD1)->D1_LOJA+(CALIASSD1)->D1_COD+(CALIASSD1)->D1_ITEM,"D1_CC") })
	...
	TRCell():New(oSection1,"F1_COND"   ,,"Cond.Pag.",/*Picture*/,6,.f.,{|| (CALIASSD1)->F1_COND })
	TRCell():New(oSection1,"E4_DESCRI" ,,"Desc.Cond.Pag",/*Picture*/,15,.f.,{|| RetField("SE4",1,xFilial("SE4")+(CALIASSD1)->F1_COND,"E4_DESCRI")})
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	SELECT D1_FILIAL,D1_DOC,     D1_SERIE,   D1_FORNECE, D1_LOJA, D1_DTDIGIT,    D1_COD,   D1_QUANT, D1_VUNIT,
	       ...
	       B1_CODITE D1_CODITE,  'C' TIPO,	 D1_ZZCODF, F1_COND, F1_ESPECIE, D1_EMISSAO, D1_CONTA, D1_PEDIDO, D1_ITEMPC, A1_CGC AS A2_CGC, F1_RECBMTO, F1_XDTCLAS
	       %Exp:cSelect%

	FROM %table:SF1% SF1
	INNER JOIN %table:SD1% SD1  ON SD1.D1_FILIAL =  %xFilial:SD1%  AND
	      ...
	      SD1.%NotDel%
	INNER JOIN %table:SB1% SB1  ON SB1.B1_FILIAL =  %xFilial:SB1%  AND
          SB1.B1_COD      =  SD1.D1_COD     AND
	      SB1.%NotDel%
	INNER JOIN %table:SA1% SA1  ON SA1.A1_FILIAL =  %xFilial:SA1%  AND
          SA1.A1_COD      =  SD1.D1_FORNECE AND
          SA1.A1_LOJA     =  SD1.D1_LOJA    AND
	      SA1.%NotDel%
	INNER JOIN %table:SF4% SF4  ON SF4.F4_FILIAL = %xFilial:SF4%   AND
	...
	SELECT D1_FILIAL, D1_DOC,     D1_SERIE,   D1_FORNECE, D1_LOJA, D1_DTDIGIT,    D1_COD,   D1_QUANT, D1_VUNIT,
	       ...
	       F1_MOEDA,  F1_TXMOEDA, F1_DTDIGIT, B1_DESC, B1_ZZSGPRD, B1_UM, B1_UPRC,  A2_NOME RAZAO, A2_NREDUZ RAZAORED, SD1.R_E_C_N_O_ SD1RECNO,
   	       B1_CODITE  D1_CODITE,  'F' TIPO, D1_ZZCODF, F1_COND, F1_ESPECIE, D1_EMISSAO, D1_CONTA, D1_PEDIDO, D1_ITEMPC, A2_CGC, F1_RECBMTO, F1_XDTCLAS
	       %Exp:cSelect%
	...
	INNER JOIN %table:SB1% SB1  ON
          ...
          SB1.B1_COD      =  SD1.D1_COD     AND
	      SB1.%NotDel%
	INNER JOIN %table:SA2% SA2  ON SA2.A2_FILIAL   =  %xFilial:SA2%  AND
...
Static Function GetVencNF(cDoc,cSerie,cFornece,cLoja,cFilnf)
	...
	cQuery := " select " + CRLF
	cQuery += " 	distinct E2_VENCREA " + CRLF
	cQuery += " from " + CRLF
	...
	cQuery += " 	and E2_FILIAL 	= '"+cFilnf+"' " + CRLF

	TcQuery cQuery New Alias &cAlias
	//TCSetField("cQuery", "E2_VENCREA", "D")

	DbSelectArea(cAlias)
	(cAlias)->(DbGoTop())
	While  (cAlias)->(!EoF())
		if Empty(cVenc)
			cVenc := dtoc(stod((cAlias)->E2_VENCREA))
		else
			cVenc +=" - "+dtoc(stod((cAlias)->E2_VENCREA))
		endif
		(cAlias)->(DbSkip())
...
Static Function GetPagNF(cDoc,cSerie,cFornece,cLoja,cFilnf)
	...
	While  (cAlias)->(!EoF())
		if Empty(cBaixa)
			cBaixa := dtoc(stod((cAlias)->E2_BAIXA))
		else
			cBaixa +=" - "+dtoc(stod((cAlias)->E2_BAIXA))
		endif
		(cAlias)->(DbSkip())
