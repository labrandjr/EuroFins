...
Ponto de Entrada localizado após a gravacao de todos os registros da nota fiscal de entrada
...
/*
Nome       			: GQREENTR
Descrição  			: Ponto de Entrada após gravação do documento de entrada
Ponto	   			:
