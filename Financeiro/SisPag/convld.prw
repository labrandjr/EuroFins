...
USER FUNCTION ConvLD()
   ...
   IF VALTYPE(M->E2_CODBAR) == NIL .OR. EMPTY(M->E2_CODBAR)
      ...
      cStr := ""
      geraLog( "Se o Campo está em Branco não Converte nada." )
   ELSE
   ...
   */
   ...
   CASE LEN(cStr) == 48
      ...
      If cFgts == "0179" .or. cFgts == "0180" .or. cFgts == "0181"
         ...
         geraLog( "Tamanho 48 (fgts 0179/0180/0181) cStr: " + cStr )
      Else
         cStr := SUBSTR(cStr,1,11)+SUBSTR(cStr,13,11)+SUBSTR(cStr,25,11)+SUBSTR(cStr,37,11)
         geraLog( "Tamanho 48 cStr: " + cStr )
      EndIf
   OTHERWISE
      cStr := cStr+SPACE(48-LEN(cStr))
      geraLog( "Diferente de 47 e 48 cStr: " + cStr )
   ENDCASE
...
Static Function geraLog( cMensagem )
   ...
   Conout("[" + DTOC(Date()) + " " + Time() + "] CONVLD - " + cMensagem )
